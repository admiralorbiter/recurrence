...
5. RESULT + UNCERTAINTY:
   - Controllable Return E[R | W_ctrl]:        +0.73 (+/- 0.05)
   - Uncontrollable Return E[R | W_yoked]:      -0.01 (+/- 0.18)
   - P(Exploit | W_ctrl):                      100.0% (+/- 0.0%)
   - P(Abstain | W_yoked):                     3.5% (+/- 9.3%)
   - Contingency Sensitivity (Exploit Delta):  +3.5% (+/- 9.3%)
   - Exploit Success Rate in W_ctrl:           91.5%
6. THREE-TIER OBSERVER SANITY LADDER:
   - Observer 1 (Goal Only):                   50.0%  [Target: <= 55% -> PASS]
   - Observer 2 (Effect History Only):         37.5%  [Target: <= 55% -> PASS]
   - Observer 3 (Joint Action+Effect History): 88.0%  [Target: >= 80% -> PASS]
