...
- **Canonical Outcome:** 
  ...
  - Item-paired metacognitive error prediction resolved **no positive self-framing metacognitive advantage** over an external observer ($\Delta_{\text{AUROC}} = +0.081$ under transcript, $\Delta_{\text{AUROC}} = -0.154$ under scaffolded state).
...
| :--- | :--- | :--- | :--- |
| **Catalog E08** | Institutional & Social Pressure on Belief Persistence | S09a (E08) | **Superseded & Refocused:** Refocused from speculative ethical/social pressure onto **Epistemic Source Attribution, Agency Boundaries, and Cue Conflicts**. Evaluated pressure via false audit challenges. |
| **Catalog E09** | Cross-Level Metacognitive Screen | S09b (E09) | **Executed:** Executed as item-paired Self vs Observer error-prediction screen under matched public information. |
